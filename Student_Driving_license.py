...
def update(): 
    ...
    label_id_tag=9596999420
    print(type(label_id_tag))
    
    label_name_tag="  Ashvini   Dharmadhikari  "
    print(type(label_name_tag))
    
    label_dob_tag=" 07/02/1983 "
    print(type(label_dob_tag))
    
    label_pin_tag=411980
    print(type(label_pin_tag))
    
    label_address_tag="PLOT NO. 556 , FLAT NO. 3, DREAM HOUSE SOCIETY,INDRAYANI NAGAR , BHOSRI,PUNE"
    print(type(label_address_tag))
    
    label_vehicle_type_tag=" Two wheeler, Four wheeler "
    print(type(label_vehicle_type_tag))
    
    label_id_tag=label_id
    label_name_tag=label_name
    label_dob_tag=label_dob
    label_pin_tag=label_pin
    label_address_tag=label_address
    label_vehicle_type_tag=label_vehicle_type
# Create a button
button1=Button(root, text="Show my License", command=update)
